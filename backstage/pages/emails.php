                        ...
                        <div class="list-group">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <textarea class="form-control" placeholder="" id="emails" onkeyup='restrict("emails"); counter("emails","cnt");'></textarea>
                                            <span class="input-group-append">
                                                <span class="input-group-text"><i class="fa fa-users"></i></span>
                                            </span>
                                            <p style="font-size:8pt; font-weight:normal">Seperate email addresses with semicolon (;) OR enter each one on a separate line</p>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <select id="inputState" class="form-control">
                                            <option>Import Emails from previous sent messages</option>
                                            <option>Import Emails from Google Account</option>
                                            <option>Import Emails from my contacts on EventGate</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="list-group-item">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="INVITATION TO THE MEMORIAL DINNER OF..."/>
                                            <span class="input-group-append">
                            ...
                            <div class="list-group-item">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" placeholder="" id="mail" style="height:100px"></textarea>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label error" for="customcheckbox2" style="margin:0px; padding:0px;" onClick="appendVal('e_url','mail','customcheckbox2')">Include my EventGate event URL</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="list-group-item text-center">
                                ...
                                <button class="btn btn-secondary">SEND EMAIL <i class="fa fa-send"></i></button>
                            </div>
